...
package org.onehippo.devx.webservices.jaxrs.jcr;
...
import org.onehippo.devx.webservices.jaxrs.jcr.model.JcrQueryResultNode;
import org.onehippo.devx.webservices.jaxrs.jcr.model.JcrSearchQuery;
import org.onehippo.devx.webservices.jaxrs.jcr.model.JcrNode;
import org.onehippo.devx.webservices.jaxrs.jcr.model.JcrQueryResult;
import org.onehippo.devx.webservices.jaxrs.jcr.util.JcrDataBindingHelper;
import org.onehippo.devx.webservices.jaxrs.jcr.util.ResponseConstants;
        ...
        try {
            ...
            while (rowIterator.hasNext()) {
                ...
                for(String column : queryResult.getColumnNames()){
                    ...
                    if(value!=null){
                        queryResultNode.addField(column, JcrDataBindingHelper.getPropertyValueAsString(value, session));
                    }
                }
